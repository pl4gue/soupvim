...
soupvim.lsp_on_attach(function(event)
    ...
    map("n", "[d", function() require("no-trouble").actions.prev() end,
        "Go to previous diagnostic in workspace (no-trouble)")
    map("n", "]d", function() require("no-trouble").actions.next() end, "Go to next diagnostic in workspace (no-trouble)")
